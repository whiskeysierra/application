...
\cvitem{Source Code}{\url{https://github.com/whiskeysierra/banshie}}
...
\cvitem{Beschreibung}{Palava ist ein extrem modulares Application-Framework für Java-Backends. Der zentrale Bestandteil ist eine mächtige Interprocess-Communication-API, die es erlaubt einheitliche Endpoints zu entwickeln die dann mit unterschiedlichste Transport-Technologien (z.B. \textsc{SOAP}, \textsc{REST}, \textsc{RMI}, \textsc{XML-RPC}, \textsc{JSON-RPC}, u.a.) genutzt werden können.}
...
\cvitem{Jahr}{2011}
\cvitem{Source Code}{\url{https://github.com/whiskeysierra/helsing}}
...
\cvitem{Art}{Semester-Projekt}
\cvitem{Jahr}{2001}
\cvitem{Source Code}{\url{https://github.com/whiskeysierra/steganography}}
...
\cvitem{Art}{Semester-Projekt}
\cvitem{Jahr}{2011}
\cvitem{Source Code}{\url{https://github.com/whiskeysierra/impaired-vision}}
...
Mit den folgenden Technologien arbeite ich entweder regelmäßig oder .
\newline

\cvitem{Sprachen}{\textsc{Java}, \textsc{SQL}, \textsc{JavaScript}, \textsc{AspectJ}, \textsc{PHP}, \textsc{HTML}, \textsc{Python}, \textsc{CSS}, \LaTeX, Shell}
